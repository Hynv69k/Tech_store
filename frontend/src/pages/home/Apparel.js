...
<a href="#" class="item"> 
	<div class="card-body">
		...
		<img src={require("../../assets/images/items/1.jpg")} class="img-sm float-right"/>
...
<a href="#" class="item"> 
	<div class="card-body">
		...
		<img src={require("../../assets/images/items/2.jpg")} class="img-sm float-right"/>
...
<a href="#" class="item"> 
	<div class="card-body">
		...
		<img src={require("../../assets/images/items/3.jpg")} class="img-sm float-right"/>
...
<a href="#" class="item"> 
	<div class="card-body">
		...
		<img src={require("../../assets/images/items/4.jpg")} class="img-sm float-right"/>
...
<a href="#" class="item"> 
	<div class="card-body">
		<h6 class="title">Home and kitchen electronic  stuff collection  </h6>
		<img src={require("../../assets/images/items/5.jpg")} class="img-sm float-right"/>
...
<a href="#" class="item"> 
	<div class="card-body">
		<h6 class="title">Home and kitchen electronic  stuff collection  </h6>
		<img src={require("../../assets/images/items/6.jpg")} class="img-sm float-right"/>
		<p class="text-muted"><i class="fa fa-map-marker-alt"></i> Guanjou, China</p>
	</div>
</a>
	</li>
...
<a href="#" class="item"> 
	<div class="card-body">
		...
		<img src={require("../../assets/images/items/7.jpg")} class="img-sm float-right"/>
